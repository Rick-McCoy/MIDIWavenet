...
if __name__ == '__main__':
    ...
    parser.add_argument('--layer_size', type=int, default=9)
    parser.add_argument('--stack_size', type=int, default=2)
    parser.add_argument('--channels', type=int, default=485)
    ...
    parser.add_argument('--out_channels', type=int, default=485)
